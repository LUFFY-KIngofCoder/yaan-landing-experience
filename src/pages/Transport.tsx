...
import { Shield, Clock, CheckCircle2, Phone, Mail, MessageCircle, Star, MapPin, DollarSign, Users } from "lucide-react";
      ...
      <section className="py-20 px-4 md:px-8 bg-muted/50">
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            {bookingSteps.map((step, index) => <motion.div key={index} initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
