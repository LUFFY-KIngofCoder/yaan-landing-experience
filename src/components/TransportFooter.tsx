    ...
    >
      <div className="container mx-auto">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 pt-8 border-t border-border"
        >
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-center md:text-right">
              ...
              <div className="flex flex-wrap justify-center md:justify-end gap-2 text-xs text-muted-foreground">
